...
(function() {
  jQuery(function() {
    var $sortableTable, cells, createRequestData, desired_width, table_width;
    createRequestData = function(model, item_id, position) {
      if (model === "artwork") {
        return {
          artwork: {
            artwork_id: item_id,
    ...
    if ($sortableTable.length > 0) {
      ...
      $sortableTable.sortable({
        ...
        update: function(e, ui) {
          var data, item_id, model, position, url;
    ...
    return $("form.artwork-filters-form select").change(function() {
...
* http://jqueryui.com
* Includes: core.js, widget.js, mouse.js, position.js, draggable.js, droppable.js, resizable.js, selectable.js, sortable.js, effect.js, effect-highlight.js
